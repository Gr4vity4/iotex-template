...
async function main() {
    ...
    const deployedBlockNumber = 15024268
    const latestBlockNumber = await provider.getBlockNumber()

    const contract: ERC721 = ERC721__factory.connect('0xd83ef1e7b581bec37535400e8cc1753fa610da09', provider)
    ...
    const tx = await provider.getTransaction('0xd0ae79f36d771dc6279b91c26243f691f348207e2daed9dcdace1af4f6a1db8e')
    console.log(tx)
